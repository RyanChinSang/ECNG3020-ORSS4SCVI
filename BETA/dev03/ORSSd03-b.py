...
from BETA.dev03.models.SimInput import press
...
from BETA.dev03.models.Controls import fetch_ctrls, print_ctrls, get_t2s_ctrls
...
def active_handler(event):
    ...
    if s2t_string:
        if all(word in s2t_string for word in
            ...
            # name = matplotlib.rcParams['savefig.directory'] + '/' + 'ORSS4SCVI_' + version + '.png'
...
configure(frame=init_frame, dir='Screenshots', version=version)
fig = plt.gcf()
ax = plt.gca()
