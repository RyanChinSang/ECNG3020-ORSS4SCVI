...
public class MultiBoxTracker {
    ...
    public synchronized void draw(final Canvas canvas) {
        ...
        int centredWidth = canvas.getWidth() / 2;
        int centredHeight = ((cvHeight / 2) - ((100 * frameWidth) / cvWidth));
        int offsetSize = ((size * cvHeight) / frameHeight) - size;
        int height_p1 = centredWidth + offsetSize;  // Right
        int width_p1 = centredHeight - offsetSize;  // Top
        int height_p2 = centredWidth - offsetSize;  // Left
        int width_p2 = centredHeight + offsetSize;  // Bottom
        RectF loc = new RectF(height_p2, width_p1, height_p1, width_p2);
